...
public interface DataPoMapper extends JpaRepository<DataPo, Long> {
    ...
    Page<DataPo> findByStoreIdAndDateGreaterThanEqualAndDateLessThanEqual(Long storeId, LocalDate beginDate, LocalDate endDate, Pageable pageable);

    Page<DataPo> findByStoreIdAndDate(Long storeId, LocalDate date, Pageable pageable);

    DataPo findByStoreIdAndDateAndBeginTimeAndEndTime(Long storeId, LocalDate date, String beginTime, String endTime);
}
