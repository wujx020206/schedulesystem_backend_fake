...
public enum ReturnNo {
     ...
     *  员工模块
     ************************************/
    STAFF_EXIST(103,"员工(id=%d)已经存在"),
    PREFERENCE_EXIST(104,"员工偏好(id=%d)已经存在"),
    PHONENUMBER_ERROR(105,"手机号码格式错误"),
    EMAIL_ERROR(106,"邮箱格式错误"),

    /***************************************************
     *   门店模块
     **************************************************/
    STORE_EXIST(199,"门店(id=%d)已经存在"),

    /***************************************************
     *   排班规则模块
     **************************************************/
    RULE_EXIST(201,"排班规则(id=%d)已经存在"),
